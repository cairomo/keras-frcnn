...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            if iter_num == epoch_length % checkpoint_length:
                # eg epoch_length = 1000, checkpoint_length = 200
                # then 1000 % 200 is 0, 1000 % 400 also 0, etc
                class_acc = losses[iter_num, 4]
                if class_acc > best_acc:
                    if C.verbose:
                        print('classifier accuracy increased from {} to {}, saving weights'.format(class_acc,best_acc))
                    best_acc = class_acc
